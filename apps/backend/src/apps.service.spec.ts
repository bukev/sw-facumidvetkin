...
describe('AppService', () => {
    ...
    describe('fetchFromSwapi', () => {
        ...
        it('should throw an error if request fails', async () => {
            ...
            await expect(
                appService.fetchFromSwapi('incorrect')
            ).rejects.toThrow('Failed to fetch incorrect: Network error');
        });
    });
    ...
    describe('fetchFromSwapiById', () => {
        ...
        it('should throw an error if request fails', async () => {
            ...
            await expect(
                appService.fetchFromSwapiById('people', '#')
            ).rejects.toThrow('Failed to fetch people: Network error');
        });
    });
    ...
    describe('Characters', () => {
        ...
        it('should fetch a character by ID and include related homeworld, movies, and starships', async () => {
            ...
            jest.spyOn(appService, 'extractIdAndNameFromUrlList').mockImplementation(async (urls: string[]) => {
    ...
    describe('Movies', () => {
        ...
        it('should fetch a movie by ID and include related characters, planets, and starships', async () => {
            ...
            jest.spyOn(appService, 'extractIdAndNameFromUrlList')
