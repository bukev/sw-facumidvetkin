...
const MovieDetailPage: React.FC = () => {
  ...
  if (loading || !movie) return <Loading fullScreen />;

  const { title, episode_id, director, producer, opening_crawl, characters, planets, starships } =
    movie;
  ...
  return (
    <main>
      <Animator active={true} duration={{ enter: 1.5, offset: 10 }}>
        ...
        <RelatedEntities type="characters" data={characters} />

        <RelatedEntities type="planets" data={planets} />

        <RelatedEntities type="starships" data={starships} />
      </Animator>
    </main>
  );
};
